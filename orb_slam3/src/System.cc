    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    mpSlamDataPub = new SlamDataProcess(this, mpFrameDrawer, mpMapDrawer, mpTracker, strSettingsFile, mpAtlas);  //zl
    mptSlamDataPub = new thread(&SlamDataProcess::Run, mpSlamDataPub);
